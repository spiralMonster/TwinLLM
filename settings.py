...
class SettingsClass(BaseSettings):
    ...
    #Models for Preference Dataset Generation:
    MISTRAL_MODEL_FOR_PREFERENCE_DATASET_GEN:str="mistral-medium-latest"
    COHERE_MODEL_FOR_PREFERENCE_DATASET_GEN:str="command-r-08-2024"
    GROQ_MODEL_FOR_PREFERENCE_DATASET_GEN:str="llama-3.3-70b-versatile"
    GWEN_MODEL_FOR_PREFERENCE_DATASET_GEN:str="qwen-flash"
    
    TEMPERATURE_FOR_PREFERENCE_DATASET_GEN:float=0.4
    MAX_RETRIES_FOR_PREFERENCE_DATASET_GEN:int=3
    
    #API KEYS FOR PREFERENCE_DATASET_GENERATION_FROM_ARTICLES:
    MISTRAL_API_KEY1_FOR_PREFERENCE_DATASET_GEN:str
    COHERE_API_KEY1_FOR_PREFERENCE_DATASET_GEN:str
    GROQ_API_KEY1_FOR_PREFERENCE_DATASET_GEN:str
    GWEN_API_KEY1_FOR_PREFERENCE_DATASET_GEN:str

    #API KEYS FOR PREFERENCE_DATASET_GENERATION_FROM_POSTS:
    MISTRAL_API_KEY2_FOR_PREFERENCE_DATASET_GEN:str
    COHERE_API_KEY2_FOR_PREFERENCE_DATASET_GEN:str
    GROQ_API_KEY2_FOR_PREFERENCE_DATASET_GEN:str
    GWEN_API_KEY2_FOR_PREFERENCE_DATASET_GEN:str

    #API KEYS FOR PREFERENCE_DATASET_GENERATION_FROM_TWEETS:
    MISTRAL_API_KEY3_FOR_PREFERENCE_DATASET_GEN:str
    COHERE_API_KEY3_FOR_PREFERENCE_DATASET_GEN:str
    GROQ_API_KEY3_FOR_PREFERENCE_DATASET_GEN:str
    GWEN_API_KEY3_FOR_PREFERENCE_DATASET_GEN:str

    #API KEYS FOR PREFERENCE_DATASET_GENERATION_FROM_REPOSITORIES:
    MISTRAL_API_KEY4_FOR_PREFERENCE_DATASET_GEN:str
    COHERE_API_KEY4_FOR_PREFERENCE_DATASET_GEN:str
